...
public class Constants {
    ...
    public static final String DEFAULT_PERMISSION_RESOURCE = "/permission/admin/device-mgt/1/user";
    public static final String DEFAULT_ROLE_NAME = "1_user";
