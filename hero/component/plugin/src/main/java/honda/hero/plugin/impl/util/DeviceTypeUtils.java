...
/**
 * Contains utility methods used by 1 plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(honda.hero.plugin.impl.util.DeviceTypeUtils.class);
