...
package honda.hero.plugin.internal;

import honda.hero.plugin.impl.util.DeviceTypeStartupListener;
import honda.hero.plugin.exception.DeviceMgtPluginException;
import honda.hero.plugin.impl.util.DeviceTypeUtils;
import honda.hero.plugin.impl.DeviceTypeManagerService;
...
/**
 * @scr.component name="honda.hero.plugin.internal.ServiceComponent"
 * immediate="true"
