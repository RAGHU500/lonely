...
package honda.hero.plugin.constants;
...
public class DeviceTypeConstants {
    ...
    public final static String DEVICE_PLUGIN_DEVICE_ID = "1_DEVICE_ID";
    public final static String STATE_ON = "ON";
    public final static String STATE_OFF = "OFF";

    //sensor events summerized table name
    public static final String SENSOR_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_`1";
    public static final String DATA_SOURCE_NAME = "jdbc/1DM_DB";
    public final static String DEVICE_TYPE_PROVIDER_DOMAIN = "carbon.super";

    //mqtt tranport related constants
    public static final String MQTT_ADAPTER_NAME = "`1_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/1/+/publisher";
    ...
    public final static String SENSOR_STREAM_DEFINITION = "org.wso2.iot.devices.`1";
